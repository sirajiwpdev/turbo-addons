...
class CounterList extends Widget_Base {
	...
	public function get_name() {
		return 'akijcement-counter-list';
	}
	...
	public function get_title() {
		return __( 'DM Counter List', 'akijcement-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'column',
			[
				'label'     => __( 'Column', 'akijcement-core' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '3',
				'options'   => [
					'3' => __( '4 Column', 'akijcement-core' ),
					'4' => __( '3 Column', 'akijcement-core' ),
					'6' => __( '2 Column', 'akijcement-core' ),
				],
				'selectors' => [
					'{{WRAPPER}} .akijcement-counter-list' => 'width: calc(100% / {{VALUE}});',
				],
			]
		);
		...
		$this->add_control( 'counter_list', [
			'label'       => __( 'Counter List', 'akijcement-core' ),
			...
			'default'     => [
				[
					...
					'count_number'  => __( '10', 'akijcement-core' ),
					'suffix_after'  => '+',
					'count_title'   => __( 'Years of Journey', 'akijcement-core' ),
				],
				[
					'icon_type'     => 'icon',
					'selected_icon' => [
					...
					'count_number'  => __( '10', 'akijcement-core' ),
					'count_title'   => __( 'Vessels in Fleet', 'akijcement-core' ),
				],
				[
					'icon_type'     => 'icon',
					'selected_icon' => [
					...
					'suffix_after'  => '+',
					'count_number'  => __( '550261', 'akijcement-core' ),
					'count_title'   => __( 'Total Deadweight', 'akijcement-core' ),
				],
				[
					'icon_type'     => 'icon',
					'selected_icon' => [
					...
					'suffix_after'  => '+',
					'count_number'  => __( '759', 'akijcement-core' ),
					'count_title'   => __( 'Total Deadweight', 'akijcement-core' ),
				],
			],
	...
	protected function render() {
		...
		foreach ( $counerLists as $item ) : ?>
            <div class="col-sm-6 col-md-6 col-xl-<?php echo esc_attr( $settings['column'] ); ?>">
                <div class="dm-counter">
                    ...
                    <div class="dm-counter__content">
						<?php if ( ! empty( $item['count_title'] ) ) : ?>
                            <p class="dm-counter__title"><?php echo $item['count_title']; ?></p>
						<?php endif; ?>
