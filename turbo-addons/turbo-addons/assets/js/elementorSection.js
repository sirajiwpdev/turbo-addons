        ...
        return this.each(function () {
            ...
            var init = function () {
                ...
                parallaxEffectEnabled = function () {
                    ...
                    if (!wglParallax.editorMode) {
                        settings = akijcement_parallax_settings[0][wglParallax.itemId];
                ...
                buildFrontParallax = function () {
                    var settings = akijcement_parallax_settings[0][wglParallax.itemId];
        ...
        return this.each(function () {
            ...
            var init = function () {
                ...
                ShapeDividerEnabled = function () {
                    ...
                    if (!wglShapeDivider.editorMode) {
                        settings = akijcement_parallax_settings[0][wglShapeDivider.itemId];
